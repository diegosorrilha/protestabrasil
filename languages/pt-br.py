...
'%d hours from now': '%d horas atrás',
'%d minutes ago': '%d minutos atrás',
'%d minutes from now': '%d minutos atrás',
'%d seconds ago': '%d segundos atrás',
'%d seconds from now': '%d segundos atrás',
...
'1 hour from now': '1 hora atrás',
'1 minute ago': '1 minuto atrás',
'1 minute from now': '1 minuto atrás',
'About': 'About',
...
'Groups': 'Groups',
'Hashtags main being monitored': 'Hashtags principais sendo monitoradas',
...
'Live Chat': 'Live Chat',
'Load more': 'Load more',
'Load more updates': 'Carregar mais atualizações',
'Logged in': 'Logged in',
